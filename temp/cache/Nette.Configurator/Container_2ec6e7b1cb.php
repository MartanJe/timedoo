<?php
// source: C:\Users\jencmart\Dropbox\development\PHPStormProjects\timedoo\app/config/config.neon 
// source: C:\Users\jencmart\Dropbox\development\PHPStormProjects\timedoo\app/config/config.local.neon 

class Container_2ec6e7b1cb extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Model\AbstractManager' => [
				1 => [
					'authenticator',
					'25_App_TrackModule_Model_ActivityManager',
					'26_App_TrackModule_Model_InviteManager',
					'27_App_TrackModule_Model_ProjectManager',
					'28_App_TrackModule_Model_TaskManager',
				],
			],
			'Nette\Object' => [
				1 => [
			...
			'App\TrackModule\Model\ActivityManager' => [1 => ['25_App_TrackModule_Model_ActivityManager']],
			'App\TrackModule\Model\InviteManager' => [1 => ['26_App_TrackModule_Model_InviteManager']],
			'App\TrackModule\Model\ProjectManager' => [1 => ['27_App_TrackModule_Model_ProjectManager']],
			'App\TrackModule\Model\TaskManager' => [1 => ['28_App_TrackModule_Model_TaskManager']],
		...
		'services' => [
			'25_App_TrackModule_Model_ActivityManager' => 'App\TrackModule\Model\ActivityManager',
			'26_App_TrackModule_Model_InviteManager' => 'App\TrackModule\Model\InviteManager',
			'27_App_TrackModule_Model_ProjectManager' => 'App\TrackModule\Model\ProjectManager',
			'28_App_TrackModule_Model_TaskManager' => 'App\TrackModule\Model\TaskManager',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\Users\jencmart\Dropbox\development\PHPStormProjects\timedoo\app',
			'wwwDir' => 'C:\Users\jencmart\Dropbox\development\PHPStormProjects\timedoo\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\Users\jencmart\Dropbox\development\PHPStormProjects\timedoo\app/../temp',
	...
	public function createService__25_App_TrackModule_Model_ActivityManager(): App\TrackModule\Model\ActivityManager
	{
		$service = new App\TrackModule\Model\ActivityManager($this->getService('database.default.context'));
		return $service;
	}


	public function createService__26_App_TrackModule_Model_InviteManager(): App\TrackModule\Model\InviteManager
	{
	...
	public function createService__27_App_TrackModule_Model_ProjectManager(): App\TrackModule\Model\ProjectManager
	{
	...
	public function createService__28_App_TrackModule_Model_TaskManager(): App\TrackModule\Model\TaskManager
	{
	...
	{
		$service = new App\TrackModule\Presenters\ProjectsPresenter($this->getService('27_App_TrackModule_Model_ProjectManager'),
			$this->getService('28_App_TrackModule_Model_TaskManager'), $this->getService('authenticator'),
			$this->getService('26_App_TrackModule_Model_InviteManager'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new App\TrackModule\Presenters\RequestsPresenter($this->getService('27_App_TrackModule_Model_ProjectManager'),
			$this->getService('28_App_TrackModule_Model_TaskManager'), $this->getService('26_App_TrackModule_Model_InviteManager'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new App\TrackModule\Presenters\StatsPresenter($this->getService('27_App_TrackModule_Model_ProjectManager'),
			$this->getService('28_App_TrackModule_Model_TaskManager'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new App\TrackModule\Presenters\TimerPresenter($this->getService('27_App_TrackModule_Model_ProjectManager'),
			$this->getService('28_App_TrackModule_Model_TaskManager'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\Users\jencmart\Dropbox\development\PHPStormProjects\timedoo\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\Users\jencmart\Dropbox\development\PHPStormProjects\timedoo\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\Users\jencmart\Dropbox\development\PHPStormProjects\timedoo\app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=timedoodb', 'timedooadmin',
			'timedooadmin', null);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_2ec6e7b1cb $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\Users\jencmart\Dropbox\development\PHPStormProjects\timedoo\app/../temp/cache/latte');
