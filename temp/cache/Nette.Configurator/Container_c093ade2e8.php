<?php
// source: /home/jencmart/Dropbox/development/web/phpstormprojects/timedoo-1.2/timedoo/app/config/config.neon 
// source: /home/jencmart/Dropbox/development/web/phpstormprojects/timedoo-1.2/timedoo/app/config/config.local.neon 

class Container_c093ade2e8 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Presenters\BasePresenter' => [
				1 => ['application.3', 'application.4', 'application.5', 'application.6'],
			],
			'App\TrackModule\Presenters\TimerPresenter' => [1 => ['application.3']],
			'App\TrackModule\Presenters\StatsPresenter' => [1 => ['application.4']],
			'App\TrackModule\Presenters\RequestsPresenter' => [1 => ['application.5']],
			'App\TrackModule\Presenters\ProjectsPresenter' => [1 => ['application.6']],
			'App\TrackModule\Presenters\LoginPresenter' => [1 => ['application.7']],
		...
		'services' => [
			...
			'application.3' => 'App\TrackModule\Presenters\TimerPresenter',
			'application.4' => 'App\TrackModule\Presenters\StatsPresenter',
			'application.5' => 'App\TrackModule\Presenters\RequestsPresenter',
			'application.6' => 'App\TrackModule\Presenters\ProjectsPresenter',
			'application.7' => 'App\TrackModule\Presenters\LoginPresenter',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => '/home/jencmart/Dropbox/development/web/phpstormprojects/timedoo-1.2/timedoo/app',
			'wwwDir' => '/home/jencmart/Dropbox/development/web/phpstormprojects/timedoo-1.2/timedoo/www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => '/home/jencmart/Dropbox/development/web/phpstormprojects/timedoo-1.2/timedoo/app/../temp',
	...
	public function createServiceApplication__3(): App\TrackModule\Presenters\TimerPresenter
	{
	...
	public function createServiceApplication__4(): App\TrackModule\Presenters\StatsPresenter
	{
	...
	public function createServiceApplication__6(): App\TrackModule\Presenters\ProjectsPresenter
	{
	...
	public function createServiceApplication__7(): App\TrackModule\Presenters\LoginPresenter
	{
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/home/jencmart/Dropbox/development/web/phpstormprojects/timedoo-1.2/timedoo/app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('/home/jencmart/Dropbox/development/web/phpstormprojects/timedoo-1.2/timedoo/app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/home/jencmart/Dropbox/development/web/phpstormprojects/timedoo-1.2/timedoo/app/../temp/cache',
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_c093ade2e8 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/home/jencmart/Dropbox/development/web/phpstormprojects/timedoo-1.2/timedoo/app/../temp/cache/latte');
