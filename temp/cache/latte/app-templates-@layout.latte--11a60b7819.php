<?php
// source: C:\Users\marti\Dropbox\development\PHPStormProjects\timedoo\app/templates/@layout.latte

use Latte\Runtime as LR;

class Template11a60b7819 extends Latte\Runtime\Template
{
    public $blocks = [
    ...
    function main()
    {
        ...
        <head>
            ...
            <!-- Bootstrap core CSS -->
            <link href="<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 12 */ ?>/css/bootstrap.css"
                  rel="stylesheet">

            <!-- Add custom CSS here -->
            <link href="<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 15 */ ?>/css/sb-admin.css"
                  rel="stylesheet">
            <link rel="stylesheet"
                  href="<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 16 */ ?>/font-awesome/css/font-awesome.min.css">
            <!-- Page Specific CSS -->
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand"
                       href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link(":Track:Timer:")) ?>">Timedoo</a>
                </div>

                <!-- Collect the nav links, forms, and other content for toggling -->
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <div id="<?php echo htmlSpecialChars($this->global->snippetDriver->getHtmlId('timerMenu')) ?>"><?php $this->renderBlock('_timerMenu', $this->params) ?></div>
                    <!--------- TOP NAVBAR  pouze ikonky ----------->
                    <ul class="nav navbar-nav navbar-right navbar-user">

                        <li class="dropdown user-dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
                                        class="fa fa-user"></i> <?php echo LR\Filters::escapeHtmlText($userName) /* line 65 */ ?>
                                <b class="caret"></b></a>
                            <ul class="dropdown-menu">
                                <li><a href="#"><i class="fa fa-user"></i> Profile settings</a></li>
                                <li class="divider"></li>
                                <li>
                                    <a href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link(":Track:Login:logout")) ?>"><i
    ...
    function blockTimerMenu($_args)
    {
        ...
        <ul class="nav navbar-nav side-nav">
            ...
            ?>><a href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link(":Track:Timer:")) ?>"><i
                            class="fa fa-clock-o"></i> Timer <?php
                    if ($active == 1) {
            ...
            ?>><a href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link(":Track:Projects:")) ?>"><i
            ...
            ?>">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bar-chart-o"></i> Stats <b
                            class="caret"></b></a>
                <ul class="dropdown-menu">
                    <li <?php
                    ...
                    ?>>
                        <a href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link(":Track:Stats:default")) ?>">Overall</a>
                    </li>
                    <li <?php
                    ...
                    ?>>
                        <a href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link(":Track:Stats:inDepth")) ?>">In-depth</a>
                    </li>
                </ul>
            </li>
            ...
            ?>>
                <a href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link(":Track:Requests:default")) ?>"><i
                            class="fa fa-bell-o"></i> Requests</a></li>
