<?php
// source: C:\Users\jencmart\Dropbox\development\PHPStormProjects\timedoo\app\TrackModule/templates/Login/default.latte

use Latte\Runtime as LR;

class Templatefe20e8afa1 extends Latte\Runtime\Template
{
    public $blocks = [
    ...
    function blockContent($_args)
    {
        ...
        <div style=" width: 300px; margin: 0 auto;">
            ...
            echo Nette\Bridges\FormsLatte\Runtime::renderFormBegin(end($this->global->formsStack), array(
                ...
                Not user yet? <a
                        href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Login:register")) ?>">Register
                    here.</a>
                <?php
