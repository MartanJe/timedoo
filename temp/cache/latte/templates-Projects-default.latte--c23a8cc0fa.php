<?php
// source: C:\Users\marti\Dropbox\development\PHPStormProjects\timedoo\app\TrackModule/templates/Projects/default.latte

use Latte\Runtime as LR;

class Templatec23a8cc0fa extends Latte\Runtime\Template
{
	public $blocks = [
...
<?php
			if ($project->client != "") {
				?>                                <span class="label label-warning"><?php echo LR\Filters::escapeHtmlText($project->client) /* line 95 */ ?></span>
<?php
			}
			else {
?>
...
?>
			...
			?>"><?php echo LR\Filters::escapeHtmlText($project->status) /* line 107 */ ?>h</td>
                        <td>
<?php
			if ($project->id_role == 1) {
?>
                                <ol class="breadcrumb cum">
                                    <li><a
                                                class="ajax" href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("ProjectArchive!", [$project->id_project])) ?>"> <?php
				if ($project->active == 0) {
?>  <i
...
?>  </a></li>
                                    ...
                                    <li><a class="ajax" href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("ProjectDelete!", [$project->id_project])) ?>"><i
                                                    class="fa fa-times red"></i></a></li>
                                </ol>
<?php
			}
			else {
				?>                                <a class="ajax" href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("ProjectLeave!", [$project->id_project])) ?>"><i
