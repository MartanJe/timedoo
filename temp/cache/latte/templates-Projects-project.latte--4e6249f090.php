...
<div class="row">
    <div class="col-lg-6">
        <h1>Project <small> <?php echo LR\Filters::escapeHtmlText($ProjectName) /* line 13 */ ?></small></h1>
    </div>
    ...
    <div class="col-lg-2">
        <h1> <a href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Projects:default")) ?>"> <button type="button" class="btn btn-success btn-lg"> <span class = "fa fa-check"> </span> Done</button></a> </h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            <li class="active"><a href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("default")) ?>"><i class="fa fa-edit"></i> Projects </a></li>
...
<?php
			...
			?>                <i class="gray">    <?php echo LR\Filters::escapeHtmlText($Description) /* line 48 */ ?> </i>
<?php
		}
?>
            </div>
...
<div id="<?php echo htmlSpecialChars($this->global->snippetDriver->getHtmlId('wholeTableTasks')) ?>"><?php
		$this->renderBlock('_wholeTableTasks', $this->params) ?></div>                </div>
...
<?php
		if ($userRole == 1) {
			?><div id="<?php echo htmlSpecialChars($this->global->snippetDriver->getHtmlId('addFormSnippetMember')) ?>"><?php
...
?>                        <tr class="clickable-row" data-href="#">
			...
			?>"><span class="gray"><i><?php echo LR\Filters::escapeHtmlText($task->author) /* line 147 */ ?></i></span></td>
...
?>">
			...
			?>"><?php echo LR\Filters::escapeHtmlText($task->status) /* line 154 */ ?> h</td>
...
?>
                                <ol  class="breadcrumb cum">
                                    <li> <a class="ajax" href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("TaskArchive!", [$task->id_task])) ?>"><?php
				if ($task->active == 0) {
...
?></a></li>
				...
				echo LR\Filters::escapeHtmlAttrUnquoted($task->id_task) /* line 162 */ ?>  data-target="#myModal2"><i class="fa fa-edit orange"></i></a></li>
                                    <li> <a class="ajax" href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("TaskDelete!", [$task->id_task])) ?>"><i class="fa fa-times red"></i></a></li>
                                </ol>
<?php
			}
			else {
...
<?php
				if ($member->id_user != $user->getID()) {
					?>                                    <p><input class = ' ajax' onclick="return OptionsSelected(this)" type=checkbox name="sel[]" value=<?php
...
?>
                                <ol  class="breadcrumb cum">
                                    <li> <a class="ajax" href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("MemberDelete!", [$member->id_user])) ?>"><i class="fa fa-times red"></i></a></li>
                                </ol>
<?php
				}
?>
...
<?php $this->renderBlock('_messagesSave', $this->params) ?>
		...
		echo $_input->getControlPart()->addAttributes(array (
		'class' => NULL,
		))->attributes() ?>><span class = "fa fa-check"> </span>Save</button>
                        </div>
<?php
		echo Nette\Bridges\FormsLatte\Runtime::renderFormEnd(array_pop($this->global->formsStack), false);
?>                    </form>
