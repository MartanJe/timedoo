...
class Templateef635b9a83 extends Latte\Runtime\Template
{
    ...
    function blockContent($_args)
    {
        ...
        <div class="row">
            <div class="col-lg-6">
                <div id="<?php echo htmlSpecialChars($this->global->snippetDriver->getHtmlId('messages')) ?>"><?php $this->renderBlock('_messages', $this->params) ?></div>
            </div>
        </div><!-- /.row -->
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="table-responsive">
                    <div id="<?php echo htmlSpecialChars($this->global->snippetDriver->getHtmlId('requestTable')) ?>"><?php $this->renderBlock('_requestTable', $this->params) ?></div>
                </div>
            </div>
        </div><!-- /.row -->
            ...
            <tr>
                ...
                <td>
                    <ol class="breadcrumb cum">
                        <li><a class="ajax"
                               href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("RequestAccept!", [$invite->id_user_from, $invite->id_project])) ?>">
                                <i class="fa fa-check green"></i> </a></li>
                        <li><a class="ajax"
                               href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("RequestDecline!", [$invite->id_user_from, $invite->id_project])) ?>"><i
