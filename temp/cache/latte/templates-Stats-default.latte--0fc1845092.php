...
<?php
		...
		foreach ($datas as $data) {
			?>                <tr data-id="<?php echo LR\Filters::escapeHtmlAttr($data['rootNum']) /* line 39 */ ?>" data-parent="<?php
...
<?php
		...
		foreach ($datas2 as $data) {
			?>                <tr data-id="<?php echo LR\Filters::escapeHtmlAttr($data['rootNum']) /* line 55 */ ?>" data-parent="<?php
