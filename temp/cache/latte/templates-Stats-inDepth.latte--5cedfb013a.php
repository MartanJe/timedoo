<?php
// source: C:\Users\marti\Dropbox\development\PHPStormProjects\timedoo\app\TrackModule/templates/Stats/inDepth.latte

use Latte\Runtime as LR;

class Template5cedfb013a extends Latte\Runtime\Template
{
	public $blocks = [
...
<?php
		...
		foreach ($datas3 as $data) {
			?>                <tr data-id="<?php echo LR\Filters::escapeHtmlAttr($data['rootNum']) /* line 41 */ ?>" data-parent="<?php
