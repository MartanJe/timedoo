<?php
// source: C:\Users\jencmart\Dropbox\development\PHPStormProjects\timedoo\app\TrackModule/templates/Timer/default.latte

use Latte\Runtime as LR;

class Templatefaa6130fa0 extends Latte\Runtime\Template
{
    public $blocks = [
                    ...
                    echo Nette\Bridges\FormsLatte\Runtime::renderFormBegin(end($this->global->formsStack), array(), false) ?>>
                        ...
                        <div class="form-group">
                            <div id="<?php echo htmlSpecialChars($this->global->snippetDriver->getHtmlId('secondSnippet')) ?>"><?php
                                $this->renderBlock('_secondSnippet', $this->params) ?></div>
                        </div>
